...
CURE_POWER      = 1.3300; -- Multiplies amount healed from Healing Magic, including the relevant Blue Magic.
...
-- DYNAMIS SETTINGS
    BETWEEN_2DYNA_WAIT_TIME = 1;       -- Hours before player can renter Dynamis. Default is 1 Earthday (24 hours).
