cd C:\Users\Shaun\Desktop\Server Test\darkstar\sql
...
del linkshells.sql
FOR %%X IN (*.sql) DO ECHO Importing %%X & "c:\program files\mysql\mysql server 5.7\bin\mysql" ffxi -h localhost -u root -pManager123/ < %%X